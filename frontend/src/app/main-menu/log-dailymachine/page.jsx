...
import { formatDate } from "../../components/LogDailyMachine/DateFormatter";
import LogDailyMachineForm from "../../components/LogDailyMachine/LogDailyMachineForm";
import LogDailyMachineTable from "../../components/LogDailyMachine/LogDailyMachineTable";
import LogDailyMachineStats from "../../components/LogDailyMachine/LogDailyMachineStats";
...
const LogDailyMachinePage = () => {
  ...
  const fetchMachines = async () => {
    try {
      ...
      const response = await fetch("/api/public/daily-machine-logs", {
        method: "GET",
        headers: {
