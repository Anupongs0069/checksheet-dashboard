// ./src/app/components/LogCheckQuality/LogCheckQualityStats.jsx
"use client";
import React from "react";

const LogCheckQualityStats = ({ darkMode, filteredResults }) => {
  const getStats = () => {
    const stats = {
      total: filteredResults.length,
      pass: filteredResults.filter((m) => m.overall_result.toLowerCase() === "pass")
        .length,
      fail: filteredResults.filter((m) => m.overall_result.toLowerCase() === "fail")
        .length,
      idle: filteredResults.filter((m) => m.overall_result.toLowerCase() === "idle")
        .length,
    };
    return stats;
  };
...
export default LogCheckQualityStats;