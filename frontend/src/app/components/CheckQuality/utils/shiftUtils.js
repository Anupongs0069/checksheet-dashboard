// ./src/app/components/CheckQuality/utils/shiftUtils.js

/**
 * Determines the current shift information based on time of day
 * @returns {Object} - Shift information containing shift code, date, and timestamp
 */
