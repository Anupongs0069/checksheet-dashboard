// src/app/utils/DailyCheck/machineApiUtils.js
...
export const checkMachineInspectionStatus = async (machineId) => {
  try {
    ...
    const response = await fetch(`/api/public/daily-machine-logs/check?machine_id=${Number(machineId)}&date=${date}&shift=${shift}`);
 ...
 */
export const fetchMachineChecklist = async (machineName, machineModel) => {
  try {
