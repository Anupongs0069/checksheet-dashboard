...
import { parseQrCodeData } from "../../utils/DailyCheck/qrScannerUtils";
import {
  ...
  saveMachineAsIdle
} from "../../utils/DailyCheck/machineApiUtils";
...
const MachineDailyCheckForm = ({ isLoggedIn, user, darkMode }) => {
  ...
  useEffect(() => {
    const loadChecklist = async () => {
      ...
      try {
        setLoading(true);
        const transformedData = await fetchMachineChecklist(machineName, machineModel);
