// src/app/components/PrintSafetyReport/PrintSafetyReportButton.jsx

"use client";
import React from "react";
import { FileText } from "lucide-react";

const PrintSafetyReportButton = ({ onClick, generating, error }) => {
  if (error) {
    return (
      <button
        onClick={onClick}
...
export default PrintSafetyReportButton;